...
class MyListsPageObject(MainPageObject):
    ...
    DESCRIPTION = None
    LANGUAGE = None
    FOLDER_BY_NAME_TPL = f"//*[@text='{FOLDER_NAME}']"
    ARTICLE_BY_TITLE_TPL = f"//*[@text='{TITLE}']"
    TITLE_TOPIC_IN_LIST = f"//*[@resource-id='org.wikipedia:id/page_list_item_container']//*[@text='Python (programming language)']"
    TITLE_DESCRIPTION_IN_LIST = f"//*[@resource-id='org.wikipedia:id/page_list_item_container']//*[@text='general-purpose programming language']"
    ...
    def wait_for_article_to_appear_by_title(self, article_title: str):
        ...
        self.wait_for_element_present((By.XPATH, article_xpath),
                                      "Cannot find saved article by title " + article_title,
                                      15)

    def wait_for_article_to_disappear_by_title(self, article_title):
        article_xpath = self.get_saved_article_xpath_by_title(article_title)
        self.wait_for_element_not_present((By.XPATH, article_xpath),
                                          "Saved article still present with title " + article_title,
                                          15)

    def assert_has_text(self):
        self.assert_element_has_text((By.XPATH,
                                      self.TITLE_TOPIC_IN_LIST),
                                     "Python (programming language)",
                                     "Cannot title of topic after remove",
                                     5)

        self.assert_element_has_text((By.XPATH,
                                      self.TITLE_DESCRIPTION_IN_LIST),
    ...
    def swipe_by_article_to_delete(self, article_title):
        ...
        self.swipe_element_to_left((By.XPATH, article_xpath), "Cannot find saved article")
